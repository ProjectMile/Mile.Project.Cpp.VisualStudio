...
#ifndef MILE_PROJECT_DEFINE_SEMANTIC_VERSION
#define MILE_PROJECT_DEFINE_SEMANTIC_VERSION(MAJOR,MINOR,PATCH) \
    MAJOR.MINOR.PATCH
#endif

#ifndef MILE_PROJECT_SEMANTIC_VERSION
#define MILE_PROJECT_SEMANTIC_VERSION \
    MILE_PROJECT_DEFINE_SEMANTIC_VERSION( \
        MILE_PROJECT_VERSION_MAJOR, \
        MILE_PROJECT_VERSION_MINOR, \
        MILE_PROJECT_VERSION_PATCH)
#endif

#ifndef MILE_PROJECT_SEMANTIC_VERSION_STRING
#define MILE_PROJECT_SEMANTIC_VERSION_STRING \
    MILE_PROJECT_MACRO_TO_STRING(MILE_PROJECT_SEMANTIC_VERSION)
#endif
...
#define MILE_PROJECT_VERSION_STRING \
    MILE_PROJECT_SEMANTIC_VERSION_STRING \
